...
class PhotonMapping
{
	...
	unsigned int m_max_nb_shots, m_nb_global_photons, m_nb_caustic_photons, m_nb_media_photons;
	...
	KDTree<Photon, 3> m_global_map, m_caustics_map, m_media_map;
...
public:
 	...
 	PhotonMapping( World *_world, unsigned int nb_global_photons, unsigned int nb_caustic_photons, unsigned int nb_media_photons,
		...
		m_nb_global_photons(nb_global_photons), m_nb_caustic_photons(nb_caustic_photons), m_nb_media_photons(nb_media_photons),
